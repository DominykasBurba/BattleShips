...
public class RandomFleetBuilder : IBoardBuilder
{
    ...
    public RandomFleetBuilder(Board board)
    {
        _board = board;
    ...
    public void BuildPart(ShipKind shipKind)
    {
        ...
        for (int tries = 0; tries < 300 && !placed; tries++)
        {
            ...
            var length = ShipFactory.Create(shipKind, new Position(0, 0), orientation).Length;
            ...
            var ship = ShipFactory.Create(shipKind, start, orientation);
